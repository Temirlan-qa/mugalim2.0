...
class _MyReviewScreenState extends State<MyReviewScreen> with SingleTickerProviderStateMixin{
  @override
  void initState() {
    super.initState();
  }
        ...
        children: [
          ...
          Container(
            decoration: const BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.only(topLeft: Radius.circular(16), topRight: Radius.circular(16.0))
            ),
                  ...
                  TextFormField(
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: ColorStyles.neutralsTextPrimaryColor, width: 1),
                      ),
                    ),
                    maxLines: 5,
                  ),
                  Padding(
                    ...
                    child: TextButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.of(context, rootNavigator: true).push(PageTransition(child: SucessReview(), type: PageTransitionType.fade));
