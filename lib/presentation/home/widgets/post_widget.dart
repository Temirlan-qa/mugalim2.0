...
class PostWidget extends StatefulWidget {
  ...
  const PostWidget( {
    ...
    this.bloc, required this.fromPage
  }) : super(key: key);
...
class _PostWidgetState extends State<PostWidget> {
  ...
  HomeDatasource homeDatasource = sl();
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      ...
      onVisibilityChanged: (VisibilityInfo info) {
        if(!viewedBox.containsKey(widget.id!)) {
          homeDatasource.viewPost(widget.id!);
          viewedBox.put(widget.id, true);
        }
      },
